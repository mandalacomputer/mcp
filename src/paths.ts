...
/** The JSON Schema for a `mandala/v1` document (OPL-3568). */
...
/**
 * Every build this account has started (OPL-3791).
 *
...
/**
 * The account's webhook subscriptions (OPL-4300; OPL-4306 here).
 *
...
/**
 * One published template, by the two halves of its ref (OPL-3789).
 *
 ...
 * rather than a claim about the parser: the platform's reference gives this parameter
