 ...
 * hop that actually knew this request said something: if one did, its sentence
 * leads, because it knows more than this file; if none did, the generic tail is
 * dropped instead of contradicted.
 *
