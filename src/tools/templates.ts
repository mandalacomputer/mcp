  ...
  server.registerTool(
    ...
    (_args, extra) =>
      guarded(async () => {
        ...
        // fan-out on the v1 surface it FAILS CLOSED: `forward` in the platform's surface layer
        ...
        // a review that had looked at the platform's proxy and not at the tier above it.
